...
$(document).ready(function() {
    ...
    var url = urlFinal + 'initialSearch5/state/' + state + '/district/' + district + '/block/' + block + '/village/' + village;
    var ourRequest = new XMLHttpRequest();
    console.log(url);
    ourRequest.open('GET', url, true);
    ourRequest.onload = function () {
    ...
    $("#editFormRights").submit(function(event) {
        ...
        var dataEdit = JSON.stringify(datastring);
        var url = urlFinal + 'editFormRightsSubmitUserMP?array='+dataEdit;
        var ourRequest = new XMLHttpRequest();
        ourRequest.open('POST', url, true);
...
function userSearch(pin, firstName, middleName, lastName, minage, maxage, occ, occother, mobile, email, gender, mark) {
    ...
    var url = urlFinal +'buttonSearch5/' + state + '/' + district + '/' + block + '/' + village + '/' + pin + '/' + firstName + '/' + middleName + '/' + lastName + '/'  + minage + '/' + maxage + '/' + occ + '/' + occother + '/' + mobile + '/' + email + '/' + gender + '/' + mark;
    console.log(url)
    var ourRequest = new XMLHttpRequest();
    ourRequest.open('GET', url, true);
    ourRequest.onload = function () {
...
function print(printData) {
    ...
    for (var x=start ;x < end; x++) {
        ...
        if(printData.civilian[x].printRequest== undefined){
            printData.civilian[x].printRequest ="-";
        }
        txt = txt + "<tr>"+ "<th>" + (x+1) + "</th>"
            ...
            + "<th>" + printData.civilian[x].messageRights+ "</th>"
