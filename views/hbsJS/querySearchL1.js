...
function blockHim(value){
    var url = urlFinal + 'valueForBlock/'+value
    var ourRequest = new XMLHttpRequest();
    ourRequest.open('GET', url, true);
    ourRequest.send();
    alert('Blocked, changes will be shown on page refresh');
...
$(document).ready(function() {
    ...
    var url = urlFinal + 'initialSearch1/state/' + state + '/district/' + district + '/block/' + block + '/village/' + village;
    var ourRequest = new XMLHttpRequest();
    console.log(url);
    ourRequest.open('GET', url, true);
    ourRequest.onload = function () {
...
function userSearch(pin, firstName, middleName, lastName, minage, maxage, occ, occother, mobile, email, gender, mark) {
    ...
    var url = urlFinal +'buttonSearch1/' + state + '/' + district + '/' + block + '/' + village + '/' + pin + '/' + firstName + '/' + middleName + '/' + lastName + '/'  + minage + '/' + maxage + '/' + occ + '/' + occother + '/' + mobile + '/' + email + '/' + gender + '/' + mark;
    console.log(url)
    var ourRequest = new XMLHttpRequest();
    ourRequest.open('GET', url, true);
    ourRequest.onload = function () {
